...
| Systèmes  a| 
Les systèmes NetApp ASA r2 suivants sont pris en charge à partir d' ONTAP 9.16.1. Ces systèmes offrent une solution matérielle et logicielle unifiée qui crée une expérience simplifiée adaptée aux besoins spécifiques des clients utilisant exclusivement un SAN.
...
| link:../learn-more/additional-supported-ontap-features.html#san-protocols["La désallocation d'espace NVMe est activée par défaut"]  a| 
