...
| Systèmes  a| 
Les systèmes NetApp ASA r2 suivants sont disponibles.  Ces systèmes offrent une solution matérielle et logicielle unifiée qui crée une expérience simplifiée adaptée aux besoins spécifiques des clients utilisant exclusivement un SAN.
