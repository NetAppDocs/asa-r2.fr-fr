...
NOTE: À partir d' ONTAP 9.18.1, la synchronisation active SnapMirror est prise en charge sur les configurations à quatre nœuds.  Dans ONTAP 9.17.1, la synchronisation active SnapMirror est prise en charge uniquement sur les configurations à deux nœuds.
