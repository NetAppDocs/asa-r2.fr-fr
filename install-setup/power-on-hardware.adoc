...
summary: 'Mettez chaque tiroir NS224 sous tension afin d"attribuer un ID de tiroir unique, mettez les contrôleurs ASA r2 sous tension et sécurisez les câbles d"alimentation.' 
---
...
|===
 ...
 a| 
image::../media/legend_icon_01.svg[Numéro de légende 1]
 a| 
