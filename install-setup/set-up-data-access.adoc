...
À partir d'ONTAP 9.19.1, FLI prend en charge le protocole iSCSI pour la connectivité du backend.

* En savoir plus sur le lien : https://docs.netapp.com/us-en/ontap-fli/get-started/learn-about-data-migration.html[ONTAP FLI migrations^].
