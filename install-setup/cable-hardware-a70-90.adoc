...
summary: 'Connectez le système de stockage ASA A70 ou ASA A90 à votre réseau et à vos baies de stockage pour activer la communication du cluster, l"accès à la gestion et la connectivité hôte SAN.' 
---
= Câblez le matériel pour les systèmes de stockage ASA A70 et ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Les emplacements d'E/S sur les ASA A70 et ASA A90 sont numérotés de 1 à 11.
+
image::../media/drw_a1K_back_slots_labeled_ieops-2162.svg[Numérotation des emplacements sur un contrôleur ASA A70 et ASA A90]
...
+
image::../media/drw_70-90_network_cabling1_ieops-1654.svg[Câble vers réseau Ethernet 100 GbE]
...
image::../media/oie_cable_sfp_gbe_copper.svg[Câble 10/25 GbE]

image::../media/drw_70-90_network_cabling2_ieops-1655.svg[Câble vers réseau Ethernet 10/25 GbE]
...
Les systèmes de stockage ASA A70 et ASA A90 prennent en charge les baies NS224 avec le module NSM100 ou NSM100B. Les principales différences entre les modules sont :
...
. Connectez le port e11b du contrôleur A au port e0b du NSM B.
+
...
.. Connectez le port e8a au port e0a du shelf 2 NSM A.
.. Connectez le port e8b au port e0b du NSM B de l'étagère 1.
+
...
.. Connectez le port e8a au port e0a du NSM B de l'étagère 2.
.. Connectez le port e8b au port e0b du NSM A de l'étagère 1.
+
