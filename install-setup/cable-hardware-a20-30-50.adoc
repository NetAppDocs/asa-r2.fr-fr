...
summary: 'Connectez le système de stockage ASA A20, ASA A30 ou ASA A50 à votre réseau et à vos baies de stockage pour permettre la communication du cluster, l"accès à la gestion et la connectivité hôte SAN.' 
---
= Câblez le matériel pour les systèmes de stockage ASA A20, ASA A30 et ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_isi_a20_switchless_2p_25gbe_cabling_ieops-2018.svg[Schéma de câblage d'un cluster sans commutateur ASA A20 utilisant un module d'E/S 25 GbE]
...
+
image::../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg[Schéma de câblage d'un cluster commuté ASA A20 utilisant un module d'E/S 25 GbE]
...
.ASA A30 ou ASA A50 avec deux modules d'E/S 40/100 GbE à 2 ports
Utilisez les ports e2b et e4b de chaque contrôleur pour vous connecter aux commutateurs du réseau hôte Ethernet.
...
.ASA A20, A30 ou A50 avec un module d'E/S 10/25 GbE à 4 ports
Utilisez les quatre ports du module d'E/S dans l'emplacement 2 pour vous connecter aux commutateurs du réseau hôte Ethernet.
...
.ASA A20, A30 ou A50 avec un module d'E/S FC 64 Gb/s à 4 ports
Utilisez les quatre ports du module d'E/S FC dans l'emplacement 2 pour vous connecter aux commutateurs réseau hôtes FC.

Sur chaque contrôleur, connectez les ports 2a, 2b, 2c et 2d aux commutateurs réseau hôte FC.
