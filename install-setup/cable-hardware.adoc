...
* Ces procédures présentent les configurations courantes. Le câblage spécifique dépend des composants commandés pour votre système de stockage. Pour plus de détails sur la configuration, voir link:https://hwu.netapp.com["NetApp Hardware Universe"^].
...
.. Reliez le port e2a du contrôleur A au commutateur de réseau du cluster B.
...
.ASA A30 et ASA A50 : deux modules d'E/S 40/100 GbE à 2 ports
[%collapsible]
=====
...
=====
.ASA A20, A30 et A50 : un module d'E/S 10/25 GbE à 4 ports
[%collapsible]
=====
...
.ASA A20, A30 et A50 : un module d'E/S FC 64 Gbit/s à 4 ports
[%collapsible]
=====
...
.A20, A30 ET A50
--
Connectez chaque contrôleur au module NSM100B correspondant sur le tiroir NS224 à l'aide des câbles de stockage fournis avec le système de stockage. Ces câbles peuvent inclure le type de câble suivant :
