...
+
Pour activer le basculement de LIF iSCSI, sélectionnez uniquement le protocole IP.
...
.Et la suite ?
Si vous avez créé une LIF IP pour iSCSI, vous pouvez utiliser l'interface de ligne de commande ONTAP pour activer le basculement automatique des LIF iSCSI.
...
Vous devez utiliser l'interface de ligne de commande ONTAP pour activer le basculement automatique des LIF iSCSI.
